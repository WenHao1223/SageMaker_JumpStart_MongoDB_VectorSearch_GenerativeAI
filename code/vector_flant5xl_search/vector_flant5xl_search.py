...
# Get all documents in the collection and start the embedding 
...
# Result is a list of docs with array fields
docs = list(response)
...
print(newline + bold + 'Given Input : ' +  unbold + llm_input_text+ newline )
